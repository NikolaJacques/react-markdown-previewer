...
function SvgFccLogo(props) {
  return (
    <svg
      className="col-1 p-0"
      viewBox={"100 -200 525 800"}
    ...
    >
      ...
      >
        <path
          id="FCC_logo_svg__a"
          d="M136.83 9.96c2.35 2.34 4.7 5.71 4.71 9.1.01 5.86-6.87 13.81-19.59 26.87C68.91 97 42.23 159.54 42.41 234.97c.2 83.45 28.26 150.47 82.8 202.41 11.47 10.25 16.18 18.31 
16.2 25.21 0 3.38-2.33 6.9-4.67 10.29-2.2 2.35-6.89 4.71-10.27 4.71-12.62.03-30.28-14.89-53.34-43.92-44.9-55.03-65.2-115.8-66.34-198.62C5.74 152.19 31.72 96 82.57 37.99c18.3-20.73 33.56-31.5 43.97-31.52 3.38-.01 6.9 1.15 10.29 3.49z"
        />
        <path
          id="FCC_logo_svg__b"
      ...
      <use fill="#0a0a23" xlinkHref="#FCC_logo_svg__a" />
      <use
        fillOpacity={0}
        stroke="#000"
        strokeOpacity={0}
        xlinkHref="#FCC_logo_svg__a"
      />
      <use fill="#0a0a23" xlinkHref="#FCC_logo_svg__b" />
      <use
        fillOpacity={0}
        stroke="#000"
        strokeOpacity={0}
        xlinkHref="#FCC_logo_svg__b"
      />
      <g>
        <use fill="#0a0a23" xlinkHref="#FCC_logo_svg__c" />
        <use
          fillOpacity={0}
          stroke="#000"
          strokeOpacity={0}
          xlinkHref="#FCC_logo_svg__c"
        />
      </g>
    </svg>
  );
